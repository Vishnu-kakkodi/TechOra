...
import { ArrowRight, PlayCircle, Star, CheckCircle, User, X, Menu, Clock, BookOpen, Languages } from 'lucide-react';
import { useAddToCartMutation, useHomeDataQuery } from '../../store/slices/userSlice';
