...
//   AWS.config.update({
//     accessKeyId: process.env.VITE_APP_ACCESS_ID,
//     secretAccessKey: process.env.VITE_APP_ACCESS_KEY,
//   });
...
//     const handleDownloadDocument = (url:unknown) => {
//       const s3 = new AWS.S3();
//       const params = {
//         Bucket: process.env.VITE_APP_INTERNAL_BUCKET_NAME,
...
//                         <button
//                           onClick={() => handleDownloadDocument(institute.documentUrl)}
        ...
        <table className="min-w-full bg-white rounded-lg">
          ...
          <tbody className="divide-y divide-gray-200">
            {institutes ? (
                ...
                <tr key={institute.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-6">
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        <Download className="h-4 w-4 mr-2" />
                        {downloading === institute.documentUrl ? 'Downloading...' : ''}
                      </button>
                    </div>
                  </td>
                  <td className="py-4 px-6">
              ...
              <tr>
                <td colSpan={7} className="py-4 px-6 text-center text-gray-500">No institutions found</td>
              </tr>
            )}
          </tbody>
        </table>
