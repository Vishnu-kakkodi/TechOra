...
// import { useInstituteApproveMutation, useInstituteListQuery, useInstituteRejectMutation } from '../../store/slices/adminSlice';
...
//   const handleReject = async (instituteId: any) => {
//     setLoading(true);
//     try {
//       const response = await instituteReject(instituteId)
//       toast.success("Institute approved successfully")
//       setStatus('rejected');
//     } catch (error) {
...
//           {currentInstitute.status!=='Active'?(          <div className="flex flex-col gap-10">
//             <button
