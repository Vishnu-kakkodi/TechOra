...
import { useNotificationQuery, useNotificationReadMutation, useUserLogoutCallMutation } from '../../store/slices/userSlice';
...
const Navbar = () => {
  ...
  return (
    <header className="sm:w[300px] md:w[500px] lg:w[700px] top-0 shadow-lg bg-white relative z-50">
          ...
          >
            ...
            <nav className="space-y-4">
              ...
              <button
                ...
                className="block w-full px-4 py-2 rounded-md text-base bg-red-100 font-medium border-2 text-gray-800 hover:bg-red-400 text-left"
              >
                Logout
              </button>
            </nav>
