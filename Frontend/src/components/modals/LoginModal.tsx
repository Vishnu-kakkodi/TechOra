    ...
    <div className="container mx-auto">
      <Modal onClose={() => setLoginModalOpen(false)}>
        <form
          ...
          className="w-[90%] sm:w-[500px] md:w-[600px] p-4 md:p-8 bg-white shadow-lg mx-auto"
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={formik.handleChange}
                value={formik.values.email}
                className="w-full px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring focus:ring-indigo-500"
              />
              {formik.touched.email && formik.errors.email && (
                <div className="text-red-500 mt-1">{formik.errors.email}</div>
              )}
            ...
            <div>
              <label className="block text-black mb-2">
                <a onClick={handleForgotPassword} className="hover:cursor-pointer hover:text-gold">
                  Forgot Password?
                </a>
              </label>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div
                onClick={handleGoogleLogin}
                className="flex items-center justify-center text-black bg-white w-[250px] h-[30px] rounded-[4px] px-2 space-x-2 cursor-pointer hover:bg-gray-100"
              >
                <FcGoogle size={20} />
                <span>Continue With Google</span>
              </div>
